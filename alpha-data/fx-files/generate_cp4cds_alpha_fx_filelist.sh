...
# EG PATH:: /badc/cmip5/data/cmip5/output1/MIROC/MIROC5/rcp45/fx/atmos/fx/r0i0p0/v20110901/areacella/areacella_fx_MIROC5_rcp45_r0i0p0.nc
...
do
    find -L $dir1/fx -mindepth 4 -maxdepth 4 -name "v????????" | while read dir2
    do
        find -L $dir2/ -type f -name '*.nc'
