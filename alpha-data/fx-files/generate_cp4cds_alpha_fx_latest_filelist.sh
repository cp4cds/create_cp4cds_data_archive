...
# EG PATH:: /badc/cmip5/data/cmip5/output1/MOHC/HadGEM2-ES/rcp26/fx/ocean/fx/r0i0p0/latest/areacello/areacello_fx_HadGEM2-ES_rcp26_r0i0p0.nc
...
do
    find -L $dir1/fx -mindepth 4 -maxdepth 4 -name "latest" | while read dir2
    do
        find -L $dir2/ -mindepth 2 -maxdepth 2 -type f -name '*.nc'
